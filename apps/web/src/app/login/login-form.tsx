 ...
 * see it to recover.
 *
 * Wrapped in a <Suspense> from the parent page because `useSearchParams`
 * forces dynamic rendering and Next.js requires the suspense boundary to
 * isolate that bailout.
 */
